...
public class ParkNowActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void fragmentInitialisePirate() {
        fragmentManager = getSupportFragmentManager();
        fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.setCustomAnimations(R.anim.enter_from_left,
                R.anim.exit_to_right);
        ParkingDetailsFragment Piratefragment = new ParkingDetailsFragment();
        fragmentTransaction.replace(R.id.fragment_container, Piratefragment);
        fragmentTransaction.commit();
